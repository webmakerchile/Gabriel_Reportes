...
- *Semántica preservada en Fases 2 y 3:* NC resta vía `sql_case(NC_DOC_TYPES_G)`, ND/Facturas suman, filtro `VALID_DOC_TYPES_G`, exclusión de dummies `OBU-*` sin nombre en metas, regla "atendido = HAVING net > 0", `VendedorCartera.activo == True`. 52/52 tests pasan en cada fase.
